...
public class XsPopUpWindow extends PopupWindow implements OnClickListener {
	...
	public XsPopUpWindow(Context context, View parent, int width,
			String method, String orderType, String timeout, String onlinePay,
			String distance) {
	...
	public void onClick(View v) {
		...
		case R.id.xs_cancel:
			...
			msg.what = 0;
			MainGrabFragment.instance.handler.sendMessage(msg);
			break;
		case R.id.xs_commit:
			sendMessage();
			dismiss();
	...
	private void sendMessage() {
		Message msg1 = MainGrabFragment.instance.handler.obtainMessage();
		msg1.what = 1;
		msg1.obj = method;
		MainGrabFragment.instance.handler.sendMessage(msg1);

		Message msg2 = MainGrabFragment.instance.handler.obtainMessage();
		msg2.what = 2;
		msg2.obj = orderType;
		MainGrabFragment.instance.handler.sendMessage(msg2);

		Message msg3 = MainGrabFragment.instance.handler.obtainMessage();
		msg3.what = 3;
		msg3.obj = timeout;
		MainGrabFragment.instance.handler.sendMessage(msg3);

		Message msg4 = MainGrabFragment.instance.handler.obtainMessage();
		msg4.what = 4;
		msg4.obj = onlinePay;
		MainGrabFragment.instance.handler.sendMessage(msg4);

		Message msg6 = MainGrabFragment.instance.handler.obtainMessage();
		msg6.what = 7;
		msg6.obj = distance;
		msg6.sendToTarget();

		Message msg5 = MainGrabFragment.instance.handler.obtainMessage();
		msg5.what = 6;
		msg5.obj = setLabels();
		msg5.sendToTarget();
