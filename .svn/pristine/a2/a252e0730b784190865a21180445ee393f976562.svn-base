...
public class PhonePopUpWindow extends PopupWindow {
	...
	public PhonePopUpWindow(final Context context, View parent, String uid,
			String sex, String occupation, String birthday, String city,
			String sname, String sPhone) {
		View view = View.inflate(context, R.layout.popup_phone, null);
		...
		commit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (phone.getText().toString().length() != 0) {
					updateHttpClient(phone.getText().toString());
				} else {
	...
	private void updateHttpClient(final String phone) {
